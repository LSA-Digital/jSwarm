...
**Dynamic topology/staffing selection:** a catalog-driven dynamic selector is not part of this public core release. Use this rubric's inline guidance directly for every ticket. This rubric is the SSoT for the frozen header grammar and review/architecture tier enums.
