...
| Outcome / NFR | Baseline | Projected delta | Measurement recipe | What falsifies "improved" | Status |
| --- | --- | --- | --- | --- | --- |
| [measure] | [current value] | [expected change] | [executable command or query] | [disconfirming result] | proposed |
