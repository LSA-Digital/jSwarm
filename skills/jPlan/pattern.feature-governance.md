...
| ----- | ---- | --------- | ----------- | --------- |
| US-XX.01 | [TICKET-YYY](https://lsadigital.atlassian.net/browse/TICKET-YYY) | [TICKET-YYY-DESC.md](TICKET-YYY-DESC.md) | [named agent slug] | [why this agent] |
| US-XX.02 | [TICKET-ZZZ](https://lsadigital.atlassian.net/browse/TICKET-ZZZ) | [TICKET-ZZZ-DESC.md](TICKET-ZZZ-DESC.md) | [named agent slug] | [why this agent] |
...
**Assertion Type Reference** (from COM-15 Assertion Decision Table):
...
| ----- | ---- | ----------- | ------ | ------ |
| US-XX.01 | [TICKET-YYY](https://lsadigital.atlassian.net/browse/TICKET-YYY) | [Story description] | [pts] | 🔴 Not started |

### Documentation
- [ ] AC-DOC-1: Update this plan with implementation notes and status
- [ ] AC-DOC-2: Update architecture docs with finalized decisions

### [TICKET-YYY](https://lsadigital.atlassian.net/browse/TICKET-YYY): Story Title — 🔴 Not started
- [ ] [Acceptance criterion 1]
- [ ] [Acceptance criterion 2]

### [TICKET-ZZZ](https://lsadigital.atlassian.net/browse/TICKET-ZZZ): Story Title — 🔴 Not started
- [ ] [Acceptance criterion 1]
- [ ] [Acceptance criterion 2]
