...
Provenance: COM-249 Slice C F-06/F-07 (`.jswarm/plans/COM-249/COM-249.specs.new-work-modularize.md`); operationalizes `/jTest` skill's `uat.md` §Round-file rule 7 and `docs/testing/uat-fix-playbook.md`'s OPEN-ledger / round-file bug-clearing pattern.
